...
const DEFAULTS = {
  ja: {
    ...
    clItems: [
      ...
      { id:"c7", title:"野菜・果物",     clCatId:"cl_shopping", checked:false },
      { id:"c8", title:"日用品",         clCatId:"cl_shopping", checked:false },
    ],
  },
  en: {
    tCats: [
      { id:"morning",   name:"Morning",   color:"#E0B030", emoji:"🌤" },
    ...
    cCats: [
      { id:"cl_morning",  name:"Morning bag", color:"#D4788A", emoji:"🎒" },
    ...
    clItems: [
      ...
      { id:"c7", title:"Vegetables & fruit",        clCatId:"cl_shopping", checked:false },
      { id:"c8", title:"Daily essentials",          clCatId:"cl_shopping", checked:false },
    ],
  },
};
